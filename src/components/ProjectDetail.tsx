  ...
  return (
    <article className="max-w-[1000px] mx-auto px-10 py-15">
      ...
      <header className="mb-12">
        ...
        <p className="text-lg leading-relaxed text-[var(--text-secondary)] max-w-[800px]">
          {project.description}
        </p>
      </header>
          ...
          <div className="flex gap-4 flex-wrap">
            {project.githubUrl && (
              <a 
                ...
                className="inline-flex items-center gap-2.5 px-7 py-3.5 text-base font-semibold border-2 border-[var(--border-color)] bg-[var(--bg-primary)] text-[var(--text-primary)] transition-all duration-200 hover:bg-[var(--text-primary)] hover:text-[var(--bg-primary)] hover:-translate-y-0.5 hover:shadow-[4px_4px_0_var(--text-primary)]"
              >
            ...
            {project.appStoreUrl && (
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2.5 px-7 py-3.5 text-base font-semibold border-2 border-[var(--text-primary)] bg-[var(--text-primary)] text-[var(--bg-primary)] transition-all duration-200 hover:bg-[var(--bg-primary)] hover:text-[var(--text-primary)] hover:-translate-y-0.5 hover:shadow-[4px_4px_0_var(--text-primary)]"
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
