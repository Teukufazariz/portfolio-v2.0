        ...
        <div className="flex flex-col justify-center gap-10 max-w-xl">
          <div>
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
              Software Engineer specializing in iOS and Apple platform
              development. I value clarity, simplicity, and building reliable
              software without unnecessary complexity. Currently exploring game
